...
const Card = (props) => {
  ...
  return (
    <div className="bg-gray-200 m-3 border-2 border-gray-700 p-4 minmax(300px, 320px)">
      <img src={image_link} />
      <br />
      <h2>
      ...
      <br />
      <a href={project_link} className="text-blue-500 underline" target="_blank" rel="noreferrer">
        View Project on OSU Project Portal
      </a>
      <br />
      <Link to={ratings_link} className="text-blue-500 underline">
        View {number_of_ratings} Student Ratings
      </Link>
    </div>
  );
};
